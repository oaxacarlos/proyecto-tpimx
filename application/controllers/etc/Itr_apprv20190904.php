...
class Itr_apprv extends CI_Controller{
  ...
  function index(){
      ...
      if(!isset($_SESSION['menus_list_user']['itr_apprv'])){
        ...
        $this->load->view('view_itr_apprv',$data);
      }
  }
  //----------------
  ...
  function show_itr_detail(){
      ...
      $this->load->view('view_itr_apprv_detail',$data);
  }
  //--------------
  ...
  function show_gl(){
      ...
      $this->load->view('view_itr_apprv_gl',$data);
  }
  //----------------------
  ...
  function super(){
      ...
      if(!isset($_SESSION['menus_list_user']['itr_apprv/super'])){
        ...
        $this->load->view('view_itr_apprv_super');
      }
  }
  ...
  function get_approval_super_generate(){
        ...
        $this->load->view('view_itr_apprv_super_generate',$data);
  }
  //-------------------
  ...
  function show_itr_detail_super(){
      ...
      $this->load->view('view_itr_apprv_detail_super',$data);
  }
  //--------------
