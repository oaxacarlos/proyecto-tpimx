...
class Itr_report extends CI_Controller{
  ...
  function index(){
      ...
      if(!isset($_SESSION['menus_list_user']['itr_report'])){
          ...
          $this->load->view('view_itr_report');
      }
  }
  //------------
  ...
  function get_itr_report_detail(){
      ...
      if($report_show_all or $is_user_can_see_all){       // show all report
          ...
          else{     // if user can't approve only show his ITR Request
      ...
      $this->load->view('view_itr_report_generate',$data);
  }
  //--------------------
  ...
  function show_itr_detail(){
      ...
      $this->load->view('view_itr_report_detail',$data);
  }
  //------------
  ...
  function track(){
      ...
      if(!isset($_SESSION['menus_list_user']['itr_report/track'])){
        ...
        $this->load->view('view_itr_report_track');
      }
  }
  //----------------
  ...
  function get_itr_report_track_generate(){
      ...
      $this->load->view('view_itr_report_track_generate',$data);
  }
  //--------------
  ...
  function trackvalue(){
      ...
      if(!isset($_SESSION['menus_list_user']['itr_report/trackvalue'])){
        ...
        $this->load->view('view_itr_report_trackvalue');
      }
  }
  //----------------
  ...
  function get_itr_report_trackvalue_generate(){
      ...
      $this->load->view('view_itr_report_trackvalue_generate',$data);
  }
  //--------------
  ...
  function balance(){
      ...
      if(!isset($_SESSION['menus_list_user']['itr_report/balance'])){
        ...
        $this->load->view('view_itr_report_balance');
      }
  }
  //----------------
  ...
  function get_itr_report_balance_generate(){
      ...
      $this->load->view('view_itr_report_balance_generate',$data);
  }
  //--------------
