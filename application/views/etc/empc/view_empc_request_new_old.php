...
<div class="container-fluid">
    Your EMPC encoded today<br>
    <span style="font-size:10px;">
      If any issue when submitting the last EMPC. Please check your EMPC encoded in here. Successfull if DataDetail and Document are giving green color.
    </span>
    <div id="empc_list_today"  style="width:100%; max-height:200px; overflow: auto;"></div>
</div>
-->
<div class="row" style="margin-top:20px; margin-left:20px;">
    ...
    <!-- Upload File -->
    <div class="border col-md-3" style="margin-top:10px;">
        <div class="row" style="padding:5px;">
