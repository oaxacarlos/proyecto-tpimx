...
<table id="result" class="table table-bordered table-striped table-sm">
  ...
  if($v_list_itr_balance == 0){}
  else{
    $i=1;
    foreach($v_list_itr_balance as $row){
        if($row['balance'] == 0) {
            $td_itr_h_code = "class='badge badge-success' style='font-size:11px;'";
        ...
        echo "<tr>";
          echo "<td>".$i."</td>";
          echo "<td><span ".$td_itr_h_code.">".$row['itr_h_code']."</span></td>";
