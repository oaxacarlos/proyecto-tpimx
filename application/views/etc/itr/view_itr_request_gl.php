...
<script>
  function choose_gl(gl_id,gl_code){
      document.getElementById('itr_gl').value = gl_id;
      document.getElementById('itr_gl_code').value = gl_code;
      $('#itr_gl_code_text').text($('#gl_code_view_'+gl_id).text()+' - '+$('#gl_name_'+gl_id).text());
