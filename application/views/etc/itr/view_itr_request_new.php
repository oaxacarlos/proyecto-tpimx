    ...
    <div class="border" style="margin-top:10px;">
      ...
      <div class="row" style="padding:10px;" id="row_input3">
          ...
          <div class="col-md-2">
            Select Customer
              <div class="input-group">
                <button class="btn btn-primary btn-sm" style="margin-left:5px;" id="btn_itr_cust_sap">SAP Customer</button>
                <button class="btn btn-danger btn-sm" style="margin-left:5px;" id="btn_itr_cust_sap_clear">Clear</button>
              </div>
          </div>
          <div class="col-md-4">
              *Customer (If not SAP Customer,input here...)
              <div class="input-group">
...
<div class="modal" id="myModalCustSap">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">SAP Customer</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <div class="modal-body" id="modal_cust_sap"></div>
    </div>
  </div>
</div>
...
$('#btn_itr_cust_sap').click(function(){
    $('#modal_cust_sap').html('Loading, Please wait...');
    //open the modal with selected parameter attached
    $('#modal_cust_sap').load(
        "<?php echo base_url();?>index.php/itr_request_new/show_cust_sap",
        function(responseText, textStatus, XMLHttpRequest) { } // complete callback
    );

    $('#myModalCustSap').modal();
});
//---------

$('#btn_itr_cust_sap_clear').click(function(){
    document.getElementById('itr_customer').value = '';
    $("#itr_customer").prop('disabled', false);
})
