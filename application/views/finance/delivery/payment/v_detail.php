...
$percentage_cost = percentage($var_data_h["invc_vendor_subtotal"], $total_sub_total );
          ...
          <?php
            ...
            foreach($var_data_d as $row){
                echo "<tr id='table_result_".$i."'>";
                  ...
                  echo "<td><input type='text' class='form-control' value='".$row["invc_cust_name"]."' disabled></td>";
...
<div class="container-fluid" style="margin-top:20px;">
  <div class="row">
    <div class="col-md-2">
      INVOICE VENDOR NO
      <input type="text" class="form-control" id="inp_invc_vendor_no" value="<?php echo $var_data_h["invc_vendor_no"]; ?>">
    </div>
    <div class="col-md-2">
      INVOICE VENDOR DATE
      <input type="text" class="form-control" id="inp_invc_vendor_date" value="<?php echo $var_data_h["invc_vendor_date"]; ?>" disabled>
    </div>
    <div class="col-md-2">
      INVOICE SUBTOTAL
      <input type="text" class="form-control" id="inp_invc_vendor_subtotal" value="<?php echo round($var_data_h["invc_vendor_subtotal"],2) ?>" onkeypress='return isNumberKey(event)'>
    </div>
    <div class="col-md-2">
      INVOICE TOTAL
      <input type="text" class="form-control" id="inp_invc_vendor_total" value="<?php echo round($var_data_h["invc_vendor_total"],2) ?>" onkeypress='return isNumberKey(event)'>
    </div>
  </div>
</div>
...
<div class="container-fluid" style="margin-top:20px;">
  <div class="row">
    <div class="col-md-2">
      PAYMENT DATE
      <input type="text" class="form-control" id="inp_invc_payment_date" value="<?php echo $var_data_h["payment_date"] ?>" disabled>
    </div>
    <div class="col-md-3">
      UUID
      <input type="text" class="form-control" id="inp_invc_vendor_uuid" value="<?php echo $var_data_h["uuid"] ?>" placeholder="UUID" disabled>
    </div>
    <div class="col-md-3">
      REMARKS
      <input type="text" class="form-control" id="inp_invc_vendor_remarks" value="<?php echo $var_data_h["remark2"] ?>" placeholder="Remarks (Optional)" disabled>
    </div>
...
function f_update(id){
  ...
  swal({
    title: "Are you sure ?",
    html: "Update the PAYMENT information",
    type: "question",
    ...
    closeOnConfirm: false
      ...
      if(result.value){
        ...
        $.ajax({
            url  : "<?php echo base_url();?>index.php/finance/delivery/payment/update2",
            type : "post",
            dataType  : 'html',
                ...
                if(responsedata.status == 1){
                  swal({
                    ...
                    setTimeout(function(){
                      ...
                      $("#tbl_invc_vendor_subtotal_"+id).text(invc_vendor_subtotal);
                      $("#tbl_invc_vendor_total_"+id).text(invc_vendor_total);
                    },100)
                  });
                }
