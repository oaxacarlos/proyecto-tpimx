...
<div class="container-fluid">
  <div class="list-group-item text-right">
  		<a href="<?php echo base_url(); ?>download/FinanceDeliveryPaymentTemplate.csv" class="btn btn-md btn-danger">Download Payment Upload Template</a>
  </div>
...
<script>
  ...
  $("#btn_upload").click(function(){
      ...
      setTimeout(function () {
        ...
        $.ajax({
          url       : "<?php echo base_url();?>index.php/finance/delivery/payment/upload_file",
          type: "POST",
          data: form_data,
          contentType: false,
          cache: false,
          ...
          success: function(data){
            ...
            if(responsedata.status){
                ...
                setTimeout(function () {
                  ...
                  $.ajax({
                    url       : "<?php echo base_url();?>index.php/finance/delivery/payment/upload_file_checking",
                    type      : 'post',
                    dataType  : 'html',
