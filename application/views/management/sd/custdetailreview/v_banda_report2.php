...
$(document).ready(function() {
    $('#tbl_report_custdetailreview_banda2').DataTable({
      "paging": false,
      "ordering": false,
    });
});
...
//---
function f_convert_excel_banda2(){
  var table2excel = new Table2Excel();
  alert("Your converted to Excel, check your DOWNLOAD folder");
  setTimeout(table2excel.export(document.querySelector('#tbl_report_custdetailreview_banda2'),"CustomerDetailReviewBanda2"),1000);
}
//---
...
<div class="containter-fluid">
    <button class="btn btn-success btn-sm"  id="btn_export_xlsx_custdetailreview_banda2" onclick=f_convert_excel_banda2()>EXCEL</button>
    <button class='btn btn-primary btn-sm' id="copy_button_custdetailreview_banda2" style='margin-left:20px;'>Copy ALL</button>
</div>

<table class="table table-bordered table-striped table-sm" id="tbl_report_custdetailreview_banda2" style="margin-top:10px;">
  <?php
