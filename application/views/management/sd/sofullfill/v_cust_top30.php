<div class="containter-fluid">
    <button class="btn btn-success btn-sm"  id="btn_export_xlsx_cust_top30">EXCEL</button>
    <button class='btn btn-primary btn-sm' id="copy_button_cust_top30" style='margin-left:20px;'>Copy ALL</button>
</div>

<table class="table table-bordered table-sm table-striped" id="tbl_cust_top30" style="margin-top:20px;">
  <thead>
    <tr>
...
document.getElementById('btn_export_xlsx_cust_top30').addEventListener('click', function() {
  alert("Your converted to Excel, check your DOWNLOAD folder");
  setTimeout(table2excel3.export(document.querySelector('#tbl_cust_top30'),"CUST-TOP30"),1000);
});
//---
</script>
