...
$(document).ready(function() {
    $('#tbl_report_delv').DataTable({
      dom: 'Bfrtip',
        buttons: [
          {
            extend: 'excel',
            title : 'Delivery-OnTime-ByDelivery'
          }
        ],
        "order": [],
        "pageLength": 20
...
<table class="table table-bordered table-sm table-striped" style="margin-top:10px;" id="tbl_report_delv">
  <thead>
    <tr>
