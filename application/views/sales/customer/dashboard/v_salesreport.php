...
<div id='tbl_sales_report_all'>
<table class="table table-bordered table-striped table-sm" style="margin-top:10px;" onselectstart="return false">
  <?php
  echo "<thead>";
    echo "<tr>";
...
<table id="tbl_report" class="table table-bordered table-striped table-sm"  style="margin-top:10px;" onselectstart="return false">
  <?php

    echo "<thead>";
      echo "<tr>";
        echo "<th id='title' class='table-dark'>Category</th>";
        echo "<th id='title' class='table-dark'>Description</th>";
        echo "<th id='title' class='table-dark'>Item No</th>";
        echo "<th id='title' class='table-dark'>".$last_2year."</th>";
        echo "<th id='title' class='table-dark'>".$last_year."</th>";

        foreach($months as $row){ echo "<th id='title' class='table-dark'>".$year."<br>(".$row.")</th>"; }

        echo "<th id='title' class='table-dark'>Total<br>(".$year.")</th>";

        if(isset($_SESSION['user_permis']["33"])) echo "<th id='title' class='table-dark'>VS Total <br>(".$last_year.")%</th>"; // 2023-09-06

        echo "<th id='title' class='table-dark'>Total<br>".$month_name_last_year."<br>(".$last_year.")</th>";

        if(isset($_SESSION['user_permis']["26"])) echo "<th id='title' class='table-dark'>% GP<br>(".$year.")</th>";
        if(isset($_SESSION['user_permis']["34"])) echo "<th id='title' class='table-dark'>Unit Price <br>(".$year.")</th>"; // 2023-09-06
        if(isset($_SESSION['user_permis']["35"])) echo "<th id='title' class='table-dark'>Total Compra <br>(".$year.")</th>"; // 2023-09-06
      echo "</tr>";
    echo "</thead>";
    ...
    echo "<tbody>";
      ...
      foreach($var_report as $row){
        ...
        echo "<tr>";
          ...
          if(isset($_SESSION['user_permis']["33"])) echo "<td id='number'>".percentage($total_per_line,$row["si_qty_last_year"])."</td>"; // 2023-09-06
          ...
          if(isset($_SESSION['user_permis']["34"])) echo "<td id='number'>".$row["unit_price_".$year]."</td>"; // 2023-09-06
          if(isset($_SESSION['user_permis']["35"])) echo "<td id='number'>".$row["line_amount_this_year"]."</td>"; // 2023-09-06
