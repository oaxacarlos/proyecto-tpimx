  ...
  <?php
    ...
    echo "<thead>";
      echo "<tr>";
        ...
        if(isset($_SESSION['user_permis']["33"])) echo "<th rowspan='2' id='title' class='table-dark'>VS Total <br>(".$last_year.")</th>"; // 2023-09-06
        ...
        if(isset($_SESSION['user_permis']["34"])) echo "<th rowspan='2' id='title' class='table-dark'>Unit Price <br>(".$year.")</th>"; // 2023-09-06
        if(isset($_SESSION['user_permis']["35"])) echo "<th rowspan='2' id='title' class='table-dark'>Total Compra <br>(".$year.")</th>"; // 2023-09-06
