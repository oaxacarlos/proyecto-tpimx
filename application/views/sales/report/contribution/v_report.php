...
<table class="table table-bordered table-striped table-sm" id="tbl_report_productreview" style="margin-top:10px;">
  <?php
    ...
    array_multisort(array_column($var_report, 'line_amount_this_year'), SORT_DESC, SORT_NATURAL|SORT_FLAG_CASE, $var_report); // sort
...
document.getElementById('btn_export_xlsx_productreview').addEventListener('click', function() {
  ...
  setTimeout(table2excel3.export(document.querySelector('#tbl_report_productreview'),"Contribution8020-"),1000);
});
//---
</script>
