...
$(document).ready(function() {
    $('#tbl_report_productreview').DataTable({
      "paging": false,
      "ordering": false,
    });
});
...
<div class="containter-fluid">
  <?php if(isset($_SESSION['user_permis']["7"])){ ?>
    <button class="btn btn-success btn-sm" onclick=f_convert_excel_sales_item_cat_filter_report()>EXCEL</button>
  <?php } ?>

  <?php if(isset($_SESSION['user_permis']["8"])){ ?>
    <button class='btn btn-primary btn-sm' id="copy_button_item_cat_filter_report" style='margin-left:20px;'>Copy ALL</button>
  <?php } ?>
</div>
...
<table class="table table-bordered table-striped table-sm" id="tbl_report_item_cat_filter" style="margin-top:10px;">
  <?php
    echo "<thead>";
      echo "<tr>";
    ...
    echo "<tbody>";
      ...
      $gp_total = 0;
      $item_cat_temp = "";
      foreach($var_report_filter as $row){
        $total_per_line = 0;
...
<div class="containter-fluid" style="margin-top:50px;">
  <?php if(isset($_SESSION['user_permis']["7"])){ ?>
    <button class="btn btn-success btn-sm" onclick=f_convert_excel_sales_item_cat_belt_report()>EXCEL</button>
  <?php } ?>

  <?php if(isset($_SESSION['user_permis']["8"])){ ?>
    <button class='btn btn-primary btn-sm' id="copy_button_item_cat_belt_report" style='margin-left:20px;'>Copy ALL</button>
  <?php } ?>
</div>
...
<table class="table table-bordered table-striped table-sm" id="tbl_report_item_cat_belt" style="margin-top:10px;">
  <?php
    echo "<thead>";
      echo "<tr>";
        echo "<th rowspan='2' id='title' class='table-dark'>No</th>";
    ...
    echo "<tbody>";
      ...
      $gp_total = 0;
      $item_cat_temp = "";
      foreach($var_report_belt as $row){
        $total_per_line = 0;
...
<div class="containter-fluid" style="margin-top:50px;">
  <?php if(isset($_SESSION['user_permis']["5"])){ ?>
    <button class="btn btn-success btn-sm"  id="btn_export_xlsx_productreview">EXCEL</button>
  <?php } ?>

  <?php if(isset($_SESSION['user_permis']["6"])){ ?>
    <button class='btn btn-primary btn-sm' id="copy_button_productreview" style='margin-left:20px;'>Copy ALL</button>
  <?php } ?>
</div>

<table class="table table-bordered table-striped table-sm" id="tbl_report_productreview" style="margin-top:10px;">
  <?php
...
document.getElementById('btn_export_xlsx_productreview').addEventListener('click', function() {
  alert("Your converted to Excel, check your DOWNLOAD folder");
  setTimeout(table2excel3.export(document.querySelector('#tbl_report_productreview'),"ProductReview-"),1000);
});
//---
</script>
