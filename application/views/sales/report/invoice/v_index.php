...
<div class="container-fluid" style="margin-top:10px;">
  <div class="row">
    ...
    <div class="col-md-1">
      ...
      <select id="inp_brand" name="doc_type" class='required form-control'>
        <option value="all">All</option>
        <option value="F">Filter</option>
        <option value="B">Belt</option>
      </select>
    </div>
    <div class="col-md-2">
...
$("#btn_go").click(function(){
    ...
    $.ajax({
        url       : "<?php echo base_url();?>index.php/sales/report/invoice_data",
        type      : 'post',
        dataType  : 'html',
        data      :  {cust_no:cust_no, from:from, to:to, doc_type:doc_type, brand:brand},
