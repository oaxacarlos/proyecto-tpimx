...
<table class="table table-bordered table-striped table-sm" id="tbl_report_item_cat" style="margin-top:10px;">
  <?php
    echo "<thead>";
      echo "<tr>";
        ...
        if($item_cat_temp == ""){
            ...
            if($item_cat_temp != $row["item_category_code"]){
                echo "<tr class='table-info'>";
                  ...
                  echo "<td>TOTAL</td>";
                  echo "<td id='number'>".$summary_cat[$item_cat_temp][$last_2year]."</td>";
                  echo "<td id='number'>".$summary_cat[$item_cat_temp][$last_year]."</td>";
                  foreach($months as $row2){
                    echo "<td id='number'>".$summary_cat[$item_cat_temp][$year.$row2]."</td>";
                  }

                  echo "<td id='number'>".$summary_cat[$item_cat_temp]["total_item_cat_this_year"]."</td>";
                  echo "<td id='number'>".$summary_cat[$item_cat_temp]["si_last_year_this_month"]."</td>";
