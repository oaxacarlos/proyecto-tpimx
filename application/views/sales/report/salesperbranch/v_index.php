    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="row">
                ...
                <div class="col-md-6">
                    <select id='datepicker_month' name="datepicker_month" class="custom-select">
...
<script>
    ...
    $("#btn_go").click(function() {
        ...
        gen_report_salesbranch(cust_code, year, month)
    })

    function gen_report_salesbranch(cust_code, year, month) {
        $("#report_salesreport_view").html("Loading, Please wait...");

        $.ajax({
            url: "<?php echo base_url(); ?>index.php/sales/report/sales_branchdata",
            type: 'post',
            dataType: 'html',
            data: {
                cust_code: cust_code,
