...
<script>
    ...
    $("#btn_go").click(function() {
        ...
        gen_report_salesyear(cust_code, month, year)
    })

    function gen_report_salesyear(cust_code, month, year) {
        $("#report_salesreport_view").html("Loading, Please wait...");
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/sales/report/get_salespermonth",
            type: 'post',
            dataType: 'html',
            data: {
                cust_code: cust_code,
