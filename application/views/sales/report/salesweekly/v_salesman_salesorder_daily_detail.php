...
tr{
  ...
  <table class="table table-bordered table-sm table-striped">
    <thead>
      <tr>
        <th colspan='4' class='table-info' style='text-align:center;'>Sales Order Daily <button onclick=f_refresh_salesman_salesorder_daily()>refresh</button></th>
      </tr>
      <tr>
        <th>Order Date</th>
        <th>Day</th>
...
function f_refresh_salesman_salesorder_daily(){
