<div class="container-fluid">
  <div class="row">
    ...
    <a href="<?php echo base_url()."index.php/wms/barcode/print_master_barcode_by_sn2?sn2=".$sn2 ?>" class="btn btn-success" id="btn_print_barcode_master" <?php echo $disabled ?> target="_blank">PRINT <?php echo $sn2; ?></a>
    ...
    <?php
      ...
      foreach($sn as $row){
          echo "<tr>";
            ...
            echo "<td>".($i+1)."</td>";
            echo "<td id='tbl_barcode_master_item_".$i."'>".$row["item_code"]."</td>";
            echo "<td id='tbl_barcode_master_sn_".$i."'>".$row["serial_number"]."</td>";
            echo "<td>".$row["name"]."</td>";
